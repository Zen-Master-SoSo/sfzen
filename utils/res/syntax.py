			...
			"opcodes"	: [
				{
					...
					"short_description"	: 'Allows to load real-time instrument scripts for SFZ instruments.',
					"value"				: {
						"type_name"	: 'string'
					}
				}
			...
			"types"				: [
				{
					...
					"opcodes"			: [
						...
						},
						{
							...
							"modulation"		: {
								"midi_cc"	: [
									{
										"name"				: 'delay_ccN',
										"short_description"	: "Region delay time after MIDI continuous controller N messages are received. If the region receives a note-off message before delay time, the region won't play.",
										"alias"				: [
											{
												"name"		: 'delay_onccN',
												"version"	: 'SFZ v2'
						...
						{
							"name"				: 'delay_samples',
							"short_description"	: 'Allows the region playback to be postponed for the specified time, measured in samples (and therefore dependent on current sample rate).',
							"version"			: 'SFZ v2',
							"value"				: {
								"type_name"	: 'integer',
								"unit"		: 'sample units'
						...
						{
							"name"				: 'end',
							"short_description"	: 'The endpoint of the sample. If unspecified, the entire sample will play.',
							"version"			: 'SFZ v1',
							"value"				: {
								"type_name"	: 'integer',
								"default"	: 'unspecified',
								...
								"midi_cc"	: [
									{
										"name"				: 'loop_lengthccN',
										"version"			: 'Cakewalk',
										"short_description"	: 'Change of loop end point.',
										"alias"				: [
											{
						...
						{
							"name"				: 'loop_mode',
							"short_description"	: 'Allows playing samples with loops defined in the unlooped mode.',
							"version"			: 'SFZ v1',
							"alias"				: [
								{
									"name"	: 'loopmode'
						...
						},
						{
							...
							"modulation"		: {
								"midi_cc"	: [
									{
										"name"				: 'loop_startccN',
										"short_description"	: 'Change of loop start point.',
										"version"			: 'Cakewalk',
										"alias"				: [
											{
						...
						{
							"name"				: 'loop_tune',
							"short_description"	: 'Tuning for only the loop segment.',
							"version"			: 'Cakewalk',
							"alias"				: [
								{
									"name"		: 'looptune',
						...
						},
						{
							...
							"modulation"		: {
								"midi_cc"	: [
									{
										"name"				: 'offset_ccN',
										"short_description"	: 'The offset used to play the sample according to last position of MIDI continuous controller N.',
										"alias"				: [
											{
												"name"		: 'offset_onccN',
												"version"	: 'SFZ v2'
						...
						{
							"name"				: 'sample_fadeout',
							"short_description"	: 'Number of seconds before the end of sample playback that the player should begin a realtime fadeout.',
							"version"			: 'Cakewalk',
							"value"				: {
								"type_name"	: 'float',
								"unit"		: 'seconds'
						...
						{
							"name"				: 'delay_beats',
							"short_description"	: 'Delays the start of the region until a certain amount of musical beats are passed.',
							"version"			: 'SFZ v2',
							"value"				: {
								"type_name"	: 'float',
								"unit"		: 'beats'
						...
						},
						{
							...
							"short_description"	: 'Delays the start of the region after a random amount of musical beats.',
							"version"			: 'ARIA',
							"value"				: {
								"type_name"	: 'float',
								"unit"		: 'beats'
						...
						{
							"name"				: 'stop_beats',
							"short_description"	: 'Stops a region after a certain amount of beats have played.',
							"version"			: 'SFZ v2',
							"value"				: {
								"type_name"	: 'float',
								"unit"		: 'beats'
						...
						{
							"name"				: 'md5',
							"short_description"	: "Calculates the <a href='https://en.wikipedia.org/wiki/MD5'>MD5</a> digital fingerprint hash of a sample file, represented as a sequence of 32 hexadecimal digits.",
							"version"			: 'SFZ v2',
							"value"				: {
								"type_name"	: 'string',
								"default"	: 'null'
						...
						{
							"name"				: 'reverse_loccN',
							"short_description"	: 'If MIDI CC N is between <code>reverse_loccN</code> and <code>reverse_hiccN</code>, the region plays reversed.',
							"version"			: 'SFZ v2',
							"value"				: {
								"type_name"	: 'integer',
								"min"		: 0,
			...
			"types"				: [
				{
					...
					"opcodes"	: [
						...
						{
							"name"				: 'polyphony',
							"short_description"	: 'Polyphony voice limit.',
							"version"			: 'SFZ v2',
							"value"				: {
								"type_name"	: 'integer'
							}
						...
						{
							"name"				: 'note_selfmask',
							"short_description"	: "Controls note-stealing behavior for a single pitch, when using <a href='/opcodes/note_polyphony'>note_polyphony</a>.",
							"version"			: 'SFZ v2',
							"value"				: {
								"type_name"	: 'string',
								"default"	: 'on',
						...
						{
							"name"				: 'rt_dead',
							"short_description"	: 'Controls whether a release sample should play if its sustain sample has ended, or not.',
							"version"			: 'SFZ v2',
							"value"				: {
								"type_name"	: 'string',
								"default"	: 'off',
						...
						{
							"name"				: 'off_curve',
							"short_description"	: "When <a href='/opcodes/off_mode'>off_mode</a> is set to time, this specifies the math to be used to fade out the regions being muted by voice-stealing.",
							"version"			: 'ARIA',
							"value"				: {
								"type_name"	: 'integer',
								"default"	: 10,
						...
						{
							"name"				: 'off_shape',
							"short_description"	: "The coefficient used by <a href='/opcodes/off_curve'>off_curve</a>.",
							"version"			: 'ARIA',
							"value"				: {
								"type_name"	: 'float',
								"default"	: -10.3616
						...
						{
							"name"				: 'off_time',
							"short_description"	: "When <a href='/opcodes/off_mode'>off_mode</a> is set to time, this specifies the fadeout time for regions being muted by voice-stealing.",
							"version"			: 'ARIA',
							"value"				: {
								"type_name"	: 'float',
								"default"	: 0.006
						...
						},
						{
							...
							"modulation"		: {
								"midi_cc"	: [
									...
									{
										"name"				: 'varNN_curveccX',
										"short_description"	: "Specifies the ‹<a href='/headers/curve'>curve</a>› number which MIDI CC X uses to modulate variable NN.",
										"value"				: {
											"type_name"	: 'integer',
											"min"		: 0,
											"max"		: 255
					...
					"opcodes"	: [
						...
						},
						{
							...
							"alias"				: [
								{
									"name"				: 'start_lohdccN',
									"short_description"	: "Like <a href='/opcodes/start_loccN'>start_loccN</a> but with floating point MIDI CCs."
								}
							]
						},
						{
							...
							"alias"				: [
								{
									"name"				: 'start_hihdccN',
									"short_description"	: "Like <a href='/opcodes/start_hiccN'>start_hiccN</a> but with floating point MIDI CCs."
								}
							]
						},
						{
						...
						},
						{
							...
							"modulation"		: {
								...
								"velocity"	: [
									{
										"name"				: 'eqN_vel2freq',
										"short_description"	: 'Frequency change of the equalizer band with MIDI velocity, in Hertz.',
										"value"				: {
											"type_name"	: 'float',
											"default"	: 0,
											"min"		: -30000,
						...
						},
						{
							...
							"modulation"		: {
								...
								"velocity"	: [
									{
										"name"				: 'eqN_vel2gain',
										"short_description"	: 'Gain change of the equalizer band with MIDI velocity, in decibels.',
										"value"				: {
											"type_name"	: 'float',
											"default"	: 0,
											"min"		: -96,
					...
					"opcodes"	: [
						...
						},
						{
							...
							"alias"				: [
								{
									"name"				: 'fil2_keycenter',
									"short_description"	: "Same as <a href='/opcodes/fil_keycenter'>fil_keycenter</a>, but used to specify the type for the second filter.",
									"version"			: 'SFZ v2'
								}
							]
						},
						{
							...
							"alias"				: [
								{
									"name"				: 'fil2_keytrack',
									"short_description"	: "Same as <a href='/opcodes/fil_keytrack'>fil_keytrack</a>, but used to specify the type for the second filter.",
									"version"			: 'SFZ v2'
								}
							]
						},
						...
						},
						{
							...
							"alias"				: [
								{
									"name"				: 'fil2_veltrack',
									"short_description"	: "Same as <a href='/opcodes/fil_veltrack'>fil_veltrack</a>, but used to specify the type for the second filter.",
									"version"			: 'SFZ v2'
								}
							]
						},
							...
							"alias"				: [
								{
									"name"				: 'pitch',
									"version"			: 'ARIA',
									"short_description"	: "Pitch change in cents. ARIA alias for <a href='/opcodes/tune'>tune</a>."
								}
							],
							"value"				: {
								"type_name"	: 'integer',
								...
								"velocity"	: [
									{
										...
										"short_description"	: 'Velocity effect on EG depth, in cents for pitch or filter cutoff.',
										"alias"				: [
											{
												"name"		: 'fil_vel2depth',
												"version"	: 'Cakewalk',
								...
								"velocity"	: [
									{
										...
										"short_description"	: 'Velocity effect on pitch EG delay time.',
										"alias"				: [
											{
					...
					"opcodes"			: [
							...
							"modulation"		: {
								"midi_cc"	: [
									...
									},
									{
										...
										"short_description"	: 'LFO depth when polyphonic aftertouch MIDI messages are received.',
										"value"				: {
											"type_name"	: 'float',
											"default"	: 0,
											"min"		: -10,
							...
							"modulation"		: {
								"midi_cc"	: [
									...
									},
									{
										...
										"short_description"	: 'LFO frequency change when channel aftertouch MIDI messages are received, in Hertz.',
										"value"				: {
											"type_name"	: 'float',
											"default"	: 0,
											"min"		: -200,
									...
									},
									{
										...
										"short_description"	: 'LFO frequency change when polyphonic aftertouch MIDI messages are received, in Hertz.',
										"value"				: {
											"type_name"	: 'float',
											"default"	: 0,
											"min"		: -200,
						...
						},
						{
							...
							"alias"				: [
								{
									"name"				: 'lfoN_waveX',
									"short_description"	: "Select the waveform type used for the waveform number X (max 8) for LFO number N, with the same allowed values as <a href='/opcodes/lfoN_wave'>lfoN_wave</a> normally can use.",
									"version"			: 'ARIA'
								}
							]
						},
